pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://18.184.66.252:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://18.184.66.252:9090/springapp1"
            echo "✅ Frontend deployed: http://18.184.66.252:9090/frontapp1"
        }
        failure {
